      ...
      <footer className={style.footer} >
        <Container>
          <div className={style.footer_up}>
            ...
            <div className={style.subs_container}>
              <h3>Підписатися</h3>
              <p>Приєднуйтесь до нашої розсилки, щоб бути в курсі новин та акцій.</p>
              <form className={style.subs_form}>
                <label>
                  <input className={style.subs_form_input} type="text" placeholder="Введіть ваш email" />
                </label>
                <button className={style.subs_form_button} type="submit">Підписатися</button>
              </form>
            </div>
          </div>
